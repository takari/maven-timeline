...
public class WebUtils {
    ...
    public static void copyResourcesToDirectory(File jar, String jarDirectory, File outputDirectory)
            throws IOException {
    ...
    //
    public static void copyResourcesToDirectory(Class<?> clazz, String jarDirectory, File outputDirectory)
            throws IOException {
